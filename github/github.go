...
func (c *Client) NewRequest(method, urlStr string, body interface{}) (*http.Request, error) {
	return c.NewRequestWithHeader(method, urlStr, body, nil)
}

// NewRequestWithHeader creates a NewRequest with extra header info provided.
func (c *Client) NewRequestWithHeader(method, urlStr string, body interface{}, header map[string]string) (*http.Request, error) {
